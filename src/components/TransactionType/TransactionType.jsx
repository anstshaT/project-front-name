...
return (
    <div className={s.transactionTypeWrapper}>
        <label className={clsx(s.typeLabel, {active: transactionType === 'income'})}>Income</label>
        ...
        <label className={clsx(s.typeLabel, {active: transactionType === 'income'})}>Expense</label>
    </div>
  );
}
